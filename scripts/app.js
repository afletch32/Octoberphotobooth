...
function showWelcome() {
  ...
  if (overlay.style) overlay.style.removeProperty("display");

  if (DOM.welcomeTitle && DOM.welcomeTitle.parentElement !== overlay)
    overlay.appendChild(DOM.welcomeTitle);
  ...
  if (startButton.parentElement !== overlay) {
  ...
  if (startButton) {
    ...
    if (startButton.style) startButton.style.removeProperty("display");
